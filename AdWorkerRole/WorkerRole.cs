...
namespace AdWorkerRole
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        public override bool OnStart()
        {
            ...
            var dbConnString = CloudConfigurationManager.GetSetting("AdDbConnectionString");
            db = new ContosoAdsContext(dbConnString);

            var result = GetConnectionString("StorageConnectionString");
        ...
        String  GetConnectionString(string settingName)
        {
            try
            {
                return RoleEnvironment.GetConfigurationSettingValue(settingName);
            }
            // If you know the specific exception,
            // please use it instead of Exception.
            catch (Exception)
            {
